...
namespace DiffMatchPatchSharp.Tests
{
    ...
    public class DiffChangeTest
    {
        ...
        public void TestSingleStringProcess()
        {
            ...
            var dc = new DiffChanges(new DiffMatchPatch(), text1, text2);
        ...
        public void TestMultipleStringProcess()
        {
            ...
            var dc = new DiffChanges(new DiffMatchPatch(), texts1, texts2);
        ...
        private static void ProcesTest(StringBuilder sb, DiffChanges.Change ch, string text, int? index = null)
        {
            switch (ch)
            {
